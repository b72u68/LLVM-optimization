...
test__entry:
  ...
  br label %label1
label1:
  %result$16 = phi i32 [%result$33, %label5], [0, %test__entry]
  %i$17 = phi i32 [%i$42, %label5], [%i$1, %test__entry]
...
main__entry:
  ...
  br label %label11
label11:
  %temp25 = phi i32 [%temp28, %label15], [0, %main__entry]
  %temp26 = phi i32 [%temp32, %label15], [%temp24, %main__entry]
