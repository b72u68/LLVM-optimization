...
label23:
  br label %label35
label35:
  %temp68 = bitcast i32 1 to i32
  %temp19$3 = icmp sle i32 %n, 1
  br i1 %temp19$3, label %label42, label %label36
label36:
...
label39:
  ...
  %sroot$6 = bitcast i32 %temp75 to i32
  br label %label43
label40:
...
label45:
  %temp46$37 = bitcast i32 -1 to i32
  br label %label50
label46:
  br label %label47
label47:
  %temp79 = phi i32 [%temp81, %label48], [%n, %label46]
  %temp13$16 = icmp sge i32 %temp79, %i$21
  br i1 %temp13$16, label %label48, label %label49
label48:
  %temp81 = sub i32 %temp79, %i$21
  br label %label47
label49:
  %temp46$37 = bitcast i32 %temp79 to i32
  br label %label50
label50:
